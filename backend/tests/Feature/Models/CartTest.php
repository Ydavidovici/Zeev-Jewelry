...
class CartTest extends TestCase
{
    ...
    public function test_create_cart()
    {
        ...
        $response = $this->actingAs($user)->post(route('carts.store'), $data);
    ...
    public function test_read_cart()
    {
        ...
        $response = $this->actingAs($cart->user)->get(route('carts.show', $cart->id));
    ...
    public function test_update_cart()
    {
        ...
        $response = $this->actingAs($cart->user)->put(route('carts.update', $cart->id), $data);
    ...
    public function test_delete_cart()
    {
        ...
        $response = $this->actingAs($cart->user)->delete(route('carts.destroy', $cartId));

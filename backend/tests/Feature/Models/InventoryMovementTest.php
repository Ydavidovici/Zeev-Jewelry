...
class InventoryMovementTest extends TestCase
{
    ...
    public function test_create_inventory_movement()
    {
        ...
        $this->assertDatabaseHas('inventory_movements', ['inventory_id' => $inventory->id, 'quantity_change' => 50]);
    }
    ...
    public function test_update_inventory_movement()
    {
        ...
        $response->assertStatus(200);
        $this->assertDatabaseHas('inventory_movements', ['id' => $inventoryMovement->id, 'quantity_change' => 100, 'type' => 'subtraction']);
    }
